...
export const nationAnnotation = {
	...
	JPN: "Arguably the best nation in BWF World Tour 2018-2020 with 85 titles as their Women's Doubles players achieving 35 titles, mainly by Yuki Fukushima / Sayaka Hirota. Tie with China but with more runner-up status (86 times).",
	INA: "The third best nation based on the achieved titles in BWF World Tour 2018-2020 with 58 titles. Dominating the Men's Double competition with 29 titles, mostly by Marcus Fernaldi Gideon / Kevin Sanjaya Sukamuljo.",
	MAS: "Achieved 17 BWF World Tour titles from 2018-2020 with Mixed Doubles sector as their most prolific title achiever (7 titles).",
	DEN: "The best european nation in BWF World Tour 2018-2020 by achieving 29 titles and 31 runner-up position.",
	TPE: "A strong nation in their BWF World Tour 2018-2020 campaign with Tai Tzu-ying being the number 1 Women's Single player for the whole 2018 until mid-2019.",
	IND: "Achieved 13 BWF World Tour titles from 2018-2020 with Men's Single sector won 10 titles, their best sector on that period.",
	...
	ENG: "The second-best nation in Europe for 2018-2020 period with 10 titles and 9 runner-up position.",
